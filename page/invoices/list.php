                            ...
                            <tr class="hover:bg-gray-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full border <?php echo getStatusColor($inv['status']); ?>">
                                        <?php echo isset($inv['status']) ? ucfirst($inv['status']) : 'Draft'; ?>
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <!-- View / Print Button (Eye Icon) -->
                                        <a href="print.php?id=<?php echo $inv['id']; ?>" class="text-blue-600 hover:text-blue-800 p-1 hover:bg-blue-50 rounded transition" title="Lihat Invoice">
